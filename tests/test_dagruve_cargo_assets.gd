...
const ASSETS := [
	"res://assets/props/carga_01.png",
	"res://assets/props/carga_02.png",
	"res://assets/props/carga_03.png",
]
...
func run() -> Array[String]:
	...
	for property in prop_script.get_script_property_list():
		if property.name == "kind" and "carga" in property.hint_string:
			has_cargo = true
	if not has_cargo:
		failures.append("kind carga não está exposto em ui/prop.gd")
	return failures
