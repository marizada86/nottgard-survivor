...
const ASSETS := [
	"res://assets/props/braseiro_01.png",
	"res://assets/props/braseiro_02.png",
	"res://assets/props/braseiro_03.png",
]
...
func run() -> Array[String]:
	...
	for property in prop_script.get_script_property_list():
		if property.name == "kind" and "braseiro" in property.hint_string:
			has_brazier = true
	if not has_brazier:
		failures.append("kind braseiro não está exposto em ui/prop.gd")
	return failures
