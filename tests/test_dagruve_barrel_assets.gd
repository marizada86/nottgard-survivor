...
const ASSETS := [
	"res://assets/props/barril_01.png",
	"res://assets/props/barril_02.png",
	"res://assets/props/barril_03.png",
]
...
func run() -> Array[String]:
	...
	for property in prop_script.get_script_property_list():
		if property.name == "kind" and "barril" in property.hint_string:
			has_barrel = true
	if not has_barrel:
		failures.append("kind barril não está exposto em ui/prop.gd")
	return failures
