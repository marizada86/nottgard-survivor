...
const ASSETS := [
	"res://assets/props/doca_01.png",
	"res://assets/props/doca_02.png",
	"res://assets/props/doca_03.png",
]
...
func run() -> Array[String]:
	...
	for property in prop_script.get_script_property_list():
		if property.name == "kind" and "doca" in property.hint_string:
			has_dock = true
	if not has_dock:
		failures.append("kind doca não está exposto em ui/prop.gd")
	return failures
