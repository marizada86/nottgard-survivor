...
const ASSETS := [
	"res://assets/props/rede_01.png",
	"res://assets/props/rede_02.png",
	"res://assets/props/rede_03.png",
]
...
func run() -> Array[String]:
	...
	for property in prop_script.get_script_property_list():
		if property.name == "kind" and "rede" in property.hint_string:
			has_net = true
	if not has_net:
		failures.append("kind rede não está exposto em ui/prop.gd")
	return failures
