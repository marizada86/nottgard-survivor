...
const ASSETS := [
	"res://assets/props/livros_01.png",
	"res://assets/props/livros_02.png",
	"res://assets/props/livros_03.png",
]
...
func run() -> Array[String]:
	...
	for property in prop_script.get_script_property_list():
		if property.name == "kind" and "livros" in property.hint_string:
			has_books = true
	if not has_books:
		failures.append("kind livros não está exposto em ui/prop.gd")
	return failures
