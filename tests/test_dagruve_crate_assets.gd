...
const ASSETS := [
	"res://assets/props/caixote_01.png",
	"res://assets/props/caixote_02.png",
	"res://assets/props/caixote_03.png",
]
...
func run() -> Array[String]:
	...
	for property in prop_script.get_script_property_list():
		if property.name == "kind" and "caixote" in property.hint_string:
			has_crate = true
	if not has_crate:
		failures.append("kind caixote não está exposto em ui/prop.gd")
	return failures
